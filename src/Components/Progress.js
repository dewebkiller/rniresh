...
import html5Import from "../images/html5.png";
import css3Import from "../images/css3.png";
import bootstrapImport from "../images/bootstrap.png";
import tailwindImport from "../images/tailwind.png";
import jqueryImport from "../images/jquery.png";
import gsapImport from "../images/gsap.png";
import javascriptImport from "../images/javascript.png";
import reactImport from "../images/react.png";
import sassImport from "../images/sass.png";
import gitImport from "../images/git.png";
import wordpressImport from "../images/wordpress.png";
import woocommerceImport from "../images/woocommerce.png";
import elementorImport from "../images/elementor.png";
import diviImport from "../images/divi.png";
import mysqlImport from "../images/mysql.png";
import phpImport from "../images/php.png";
import photoshopImport from "../images/photoshop.png";
import adobexdImport from "../images/adobe-xd.png";
...
const tailwind = getSrc(tailwindImport);
const jquery = getSrc(jqueryImport);
const gsap = getSrc(gsapImport);
const javascript = getSrc(javascriptImport);
const react = getSrc(reactImport);
const sass = getSrc(sassImport);
const git = getSrc(gitImport);
const wordpress = getSrc(wordpressImport);
const woocommerce = getSrc(woocommerceImport);
const elementor = getSrc(elementorImport);
const divi = getSrc(diviImport);
const mysql = getSrc(mysqlImport);
const php = getSrc(phpImport);
const photoshop = getSrc(photoshopImport);
    ...
    <section className="container relative overflow-hidden mx-auto px-4 sm:px-6 skills-section">
      <div className="px-5 py-20">
        ...
        <div className="md:grid md:grid-cols-12 md:gap-6">
          ...
          <div
            className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6 my-20 skills-right"
            data-aos="fade-left"
            data-aos-delay="500"
          >
            ...
            <ul className="skills__items my-20">
              ...
              <li
                ...
                data-aos-delay="500"
              >
                <Tooltip title="gsap" arrow placement="top">
                  <div className="skills__item__icon">
