    ...
    async function loadPosts() {
      try {
        const response = await fetch(
          "https://www.dewebkiller.com/wp-json/wp/v2/posts?_embed&per_page=3",
        );
              ...
              <div className="blog-content-top">
                ...
                <div className="p-5">
                  <ul className="flex flex-wrap justify-between">
                    <li className="dark:text-gray-400">Niresh Shrestha</li>
                  ...
                  <p
                    className="my-5 font-normal text-gray-700 dark:text-gray-400"
