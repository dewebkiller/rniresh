      ...
      <div className="container mx-auto pb-20">
        <div className="md:grid md:grid-cols-12 md:gap-6">
          ...
          <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-8 lg:col-span-8 Blogsingle-wrapper">
            <img src={getSrc(Thumbnail)} alt="" className="thumbnail" />
            <div className="author-top flex justify-between items-end pb-2 mb-5">
              <div className="author-left  md:gap-6 flex justify-between">
                <div className="author-thumbnail">
                  <img src={getSrc(author)} alt="Authos" />
                </div>
            ...
            <blockquote className="relative border-s-4 ps-4 sm:ps-6 dark:border-gray-700 bg-bg_light_primary p-5 mb-5">
  <p className="text-gray-800 sm:text-xl mb-0"><em>
...
<p>
            ...
            <Link href={'/'} className="button-visitesite">Visite site</Link>
            <img src={getSrc(Thumbnail)} alt="" className="content-image" />
